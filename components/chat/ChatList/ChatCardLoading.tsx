export default function ChatCardStudentLoading() {
  return (
    ...
    >
      <div className="bg-slate-200 min-w-[48px] min-h-[48px] rounded-full mr-4 lg:hidden"></div>
      <div className="bg-slate-200 min-w-[54px] min-h-[54px] rounded-full hidden lg:block lg:mr-4"></div>
      <div className="flex flex-col w-full gap-1">
        ...
        <div className="min-w-[277.19px] min-h-[21px] lg:min-w-[316.8px] lg:min-h-[24px] bg-slate-200 rounded"></div>
      </div>
    </div>
  );
}
