  ...
  return (
    <>
      <div
        ...
        className={`${
          isShowModal ? "opacity-100" : "opacity-0 invisible"
        } flex duration-300 justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50`}
      >
      ...
      <div
        className={`fixed inset-0 z-40 bg-neutral-800 duration-300  ${
          isShowModal ? "opacity-60" : "opacity-0 invisible"
        }`}
      ></div>
    </>
  );
